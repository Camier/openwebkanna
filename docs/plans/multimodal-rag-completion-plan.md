...
### Phase 3: Payload & Validation (15 min)
- [ ] 3.1 Backfill document metadata
- [ ] 3.2 Validate collection completeness
- [ ] 3.3 Test retrieval queries
...
- [x] Qdrant (running on localhost:6335)
- [x] GPU (RTX 5000 16GB)
...
- Full payload: document_id, page_id, figure_id, caption, image_uri, and document metadata

...
> **Reference Snapshot Baseline:** OpenWebUI v0.8.3 | **Last Updated:** 2026-02-18
...
> **Snapshot Notice:** This guide is a reference snapshot compiled around OpenWebUI v0.8.3. Use the runbooks and config files for current repository behavior.

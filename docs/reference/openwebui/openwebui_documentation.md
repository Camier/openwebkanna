...
> **Reference Snapshot:** Upstream OpenWebUI docs scrape captured through 2025-02-07.
> **Runtime Truth For This Repo:** `README.md`, `docs/REPO_MAP.md`, `docs/runbooks/*`, `config/env/.env.example`, and `config/compose/docker-compose.yml`
> **Snapshot Notice:** Commands and version pins in this document reflect the upstream docs snapshot and may not match this repository's current deployment defaults.

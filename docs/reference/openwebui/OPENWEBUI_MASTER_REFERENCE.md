...
> **Snapshot Notice:** This document is a reference snapshot compiled around the OpenWebUI v0.8.3 era. Use it for broad technical background, not as the live deployment source of truth for this repo.
...
| [Troubleshooting Runbook](../../runbooks/TROUBLESHOOTING.md) | Common issues and solutions | 326 lines |

...
- Evaluation: `eval/run-retrieval-eval.sh` for canonical `multimodal_retrieval_api` retrieval evals, with optional legacy OpenWebUI migration coverage
...
- Image utilities: `embed_images_in_chunks.py`, `blip_caption.py`, `rag/build_multimodal_index.py`, `rag/render-multimodal-answer.sh`, `rag/render-multimodal-answer-v2.sh` for canonical retrieval rendering with optional legacy OpenWebUI fallback

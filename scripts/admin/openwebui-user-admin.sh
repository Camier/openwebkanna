...
#
# Usage:
#   ./scripts/admin/openwebui-user-admin.sh --email you@example.com
...
#   ./scripts/admin/openwebui-user-admin.sh --email you@example.com --reset-password --no-restart
###############################################################################
...
usage() {
    cat <<'EOF'
Usage:
  ./scripts/admin/openwebui-user-admin.sh --email you@example.com [--role admin|user] [--reset-password] [--no-restart]

...
CLIPROXYAPI_START_SCRIPT="${CLIPROXYAPI_START_SCRIPT:-./scripts/cliproxyapi/start-cliproxyapi.sh}"
CLIPROXYAPI_STOP_SCRIPT="${CLIPROXYAPI_STOP_SCRIPT:-./scripts/cliproxyapi/stop-cliproxyapi.sh}"

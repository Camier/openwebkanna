...
Examples:
  ...
  ./scripts/cliproxyapi/cli-proxy-api.sh models openwebui
  ./scripts/cliproxyapi/cli-proxy-api.sh models vllm
  ./scripts/cliproxyapi/cli-proxy-api.sh --api-key "$OPENWEBUI_API_KEY" chat --model llama-3.1-8b --message "Summarize this paper."
  ./scripts/cliproxyapi/cli-proxy-api.sh chat --service vllm --model meta-llama/Llama-3.1-8B-Instruct --message "Hello" --temperature 0.2 --max-tokens 200
  ./scripts/cliproxyapi/cli-proxy-api.sh files list
  ./scripts/cliproxyapi/cli-proxy-api.sh files upload --path ./data/pdfs/paper.pdf
  ./scripts/cliproxyapi/cli-proxy-api.sh knowledge list
EOF
}
